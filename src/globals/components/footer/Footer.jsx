      ...
      <footer className="bg-footer-bg text-footer-text font-sans dark:bg-gray-900 mt-2">
        <div className="container px-6 py-12 mx-auto">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            <div className="sm:col-span-2">
              ...
              <div className="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
                <input
                  ...
                  style={{ "::placeholder": { color: "gray" } }} // Adjusted placeholder color
                />
            ...
            <div>
              <p className="font-semibold text-gray-800 dark:text-black">Quick Link</p>

              <div className="flex flex-col items-start mt-5 space-y-2">
                <Link to={''} className="text-gray-600 transition-colors duration-300 dark:text-gray-900 dark:hover:text-blue-400 hover:cursor-pointer hover:text-blue-500">
                  Home
                </Link>
                <Link to={'/about'} className="text-gray-600 transition-colors duration-300 dark:text-gray-900 dark:hover:text-blue-400 hover:cursor-pointer hover:text-blue-500">
                  About Us
                </Link>
                <Link to={'/team'} className="text-gray-600 transition-colors duration-300 dark:text-gray-900 dark:hover:text-blue-400 hover:cursor-pointer hover:text-blue-500">
                  Team
                </Link>
                <Link to={'/contact'} className="text-gray-600 transition-colors duration-300 dark:text-gray-900 dark:hover:text-blue-400 hover:cursor-pointer hover:text-blue-500">
                  Contact 
                </Link>
              </div>
            </div>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <div className="flex flex-1 gap-4 hover:cursor-pointer justify-center sm:justify-start">
              <img
            ...
            <div className="flex mr-24 gap-4 hover:cursor-pointer justify-center sm:justify-end">
              <img
