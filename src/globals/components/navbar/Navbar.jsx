...
if(this.pageYOffset>300){
  ...
  return (
      <nav className={`fixed top-0 z-10 w-full bg-white transition-all delay-75 duration-700 ease-in-out ${ShowTime?"bg-opacity-100 shadow-lg":"bg-opacity-20"}  `}>
        <div className="container m-auto px-2 md:px-12 lg:px-7">
          <div className="flex flex-wrap items-center justify-between py-3 gap-6 md:py-4 md:gap-0">
            ...
            <div className="hidden w-full lg:flex flex-wrap justify-end items-center space-y-6 p-6 rounded-xl bg-white
             md:space-y-0 md:p-0 md:flex-nowrap md:bg-transparent lg:w-7/12">
